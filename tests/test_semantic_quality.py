...
class SemanticQualityBaselineTests(unittest.TestCase):
    ...
    def test_legacy_corpus_has_safe_nonzero_reduction(self) -> None:
        ...
        rows = [
            {"ai_req_id": "L-PM1", "title": "PM1点对多点协议配置文件要求", "module": "通信协议",
             "description": "支持PM1点对多点协议配置。"},
            {"ai_req_id": "L-PM2", "title": "PM2点对多点协议配置文件要求", "module": "通信协议",
             "description": "支持PM2点对多点协议配置。"},
            ...
            {"ai_req_id": "L-NR", "title": "不可更换电池GdM的电池寿命要求", "module": "环境可靠性"},
            {"ai_req_id": "L-R", "title": "可更换电池GdM的电池寿命要求", "module": "环境可靠性"},
    ...
    def test_historical_test18_sample_preserves_known_merge_and_split_decisions(self) -> None:
        ...
        fixture = BASELINE.parents[1] / "tests" / "fixtures" / "test18_functional_synthesis_sample.json"

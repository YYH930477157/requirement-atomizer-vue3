...
class BlueBookCoverageReportTests(unittest.TestCase):
    def test_report_summarizes_current_kb_coverage(self) -> None:
        ...
        self.assertEqual(report["object_instances"]["by_table"]["13"], 79)
        ...
        self.assertEqual(report["object_instances"]["by_table"]["14"], 116)
        self.assertEqual(report["object_instances"]["by_table"]["15"], 11)
        self.assertEqual(report["object_instances"]["by_table"]["16"], 12)
        ...
        self.assertEqual(report["object_instances"]["by_table"]["24"], 32)

...
- Current compiled coverage after the ABNT bulk OBIS import:
  - 726 total compiled Obsidian entries.
  - 87/87 Blue Book Part 2 COSEM interface classes, all 87 with attributes or methods.
  - Strict Blue Book snapshot: 35 deeply enriched classes and 35 catalogue-seed classes.

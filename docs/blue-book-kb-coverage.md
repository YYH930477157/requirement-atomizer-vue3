...
- Part 2 operational semantics: all 87 current interface classes carry at least attributes or methods in the compiled KB. The stricter machine-readable Blue Book snapshot currently classifies 35 classes as deeply enriched and 35 as catalogue seeds based on methods/access semantics or multi-attribute depth.

...
ABNT Appendix 9 row-level COSEM object `Duration of current long power failures in phase L3` with OBIS pattern `0-0:94.55.103.255` and interface class 3 (Register). time to failure current power (open) in Phase W
...
```json metadata
{
  ...
  "source_refs": [
    {
      ...
      "section": "TBL-000049-R000010, TBL-000049"
    }
  ],
  "applicable_notes": [
  ...
  "bulk_import": {
    ...
    "source_item_id": "TBL-000049-R000010",
    "source_refs": [
      "BLK-000664",
      "TBL-000049-R000010",
      "TBL-000049"

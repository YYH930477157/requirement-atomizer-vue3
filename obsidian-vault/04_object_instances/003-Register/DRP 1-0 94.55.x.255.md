...
Row-level Register object at logical name `1-0:94.55.x.255`. DRP.
...
```json metadata
{
  ...
  "source_refs": [
    ...
    },
    {
      ...
      "section": "DRP at 1-0:94.55.x.255"
    }
  ],
  "applicable_notes": [
    "Use this row when matching requirements about drp.",
    "ABNT Appendix 9 describes this object as: DRP."
  ]
}
```

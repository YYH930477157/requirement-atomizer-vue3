...
# 单一来源：测试直接复用 catalog 的当前类清单，避免与 blue_book_catalog 双清单漂移
# （历史上这份测试清单曾漏掉 Push setup 类 40）。
from requirement_kb.blue_book_catalog import (
    PART2_CURRENT_CLASSES as BLUE_BOOK_PART2_CURRENT_CLASSES,
)

...
Row-level Register object at logical name `1-0:94.55.x.255`. CKD.
...
```json metadata
{
  ...
  "source_refs": [
    ...
    },
    {
      ...
      "section": "CKD at 1-0:94.55.x.255"
    }
  ],
  "applicable_notes": [
    "Use this row when matching requirements about ckd.",
    "ABNT Appendix 9 describes this object as: CKD."
  ]
}
```

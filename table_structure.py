"""表格结构与单元格级需求闭环底座（table-structure-v10）。
...
# v10 combines the independently developed v9 behaviors: lettered composite
# headers extend through (z), and consecutive dotted clause rows identify a

...
ABNT Appendix 9 row-level COSEM object `Timeout open session for reading client through PLC channel` with OBIS pattern `0-0:94.55.51.255` and interface class 3 (Register).
...
```json metadata
{
  ...
  "source_refs": [
    {
      ...
      "section": "TBL-000072-R000006, TBL-000072"
    }
  ],
  "applicable_notes": [
  ...
  "bulk_import": {
    ...
    "source_item_id": "TBL-000072-R000006",
    "source_refs": [
      "BLK-000730",
      "TBL-000072-R000006",
      "TBL-000072"

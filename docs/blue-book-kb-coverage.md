...
- Part 2 operational semantics: all 105 current interface classes carry at least attributes or methods in the compiled KB. The stricter machine-readable Blue Book snapshot currently classifies 35 classes as deeply enriched and 53 as catalogue seeds based on methods/access semantics or multi-attribute depth. The 18 classes added on 2026-06-27 are catalogue seeds (logical_name only) pending later attribute/method/access enrichment.

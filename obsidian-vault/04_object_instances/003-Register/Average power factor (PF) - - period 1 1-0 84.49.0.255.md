...
Row-level Register object at logical name `1-0:84.49.0.255`. Average of power factor (PF-), period 1
...
```json metadata
{
  ...
  "source_refs": [
    ...
    },
    {
      ...
      "section": "Average power factor (PF) - - period 1 at 1-0:84.49.0.255"
    }
  ],
  "applicable_notes": [

...
Row-level Register object at logical name `1-0:63.7.0.255`. Instantaneous reactive power (+Q) phase L3
...
```json metadata
{
  ...
  "value_group_mapping": {
    "A": "1 electricity",
    "B": "0 no channel",
    "C": "63 reactive power (+Q) phase L3",
  ...
  "source_refs": [
    ...
    },
    {
      ...
      "section": "Instantaneous reactive power + (Q) (phase L3) at 1-0:63.7.0.255"
    }
  ],
  "applicable_notes": [

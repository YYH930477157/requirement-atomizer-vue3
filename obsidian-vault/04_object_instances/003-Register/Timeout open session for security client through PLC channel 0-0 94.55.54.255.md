...
ABNT Appendix 9 row-level COSEM object `Timeout open session for security client through PLC channel` with OBIS pattern `0-0:94.55.54.255` and interface class 3 (Register).
...
```json metadata
{
  ...
  "source_refs": [
    {
      ...
      "section": "TBL-000073-R000004, TBL-000073"
    }
  ],
  "applicable_notes": [
  ...
  "bulk_import": {
    ...
    "source_item_id": "TBL-000073-R000004",
    "source_refs": [
      "BLK-000732",
      "TBL-000073-R000004",
      "TBL-000073"
